...
const MIND_MAPS = {
  "four-dimensions": [
    { title: "Four Dimensions Overview", file: "assets/mindmaps/four-dimensions-overview.html", sourceNote: "HTML version of your Four Dimensions overview mind map." },
    { title: "Organization and People", file: "assets/mindmaps/organisations-and-people.html", sourceNote: "HTML version of your Organization and People mind map." },
    { title: "Information and Technology", file: "assets/mindmaps/information-and-technology.html", sourceNote: "HTML version of your Information and Technology mind map." },
    { title: "Partners and Suppliers", file: "assets/mindmaps/partners-and-suppliers.html", sourceNote: "HTML version of your Partners and Suppliers mind map." },
    { title: "Value Streams and Processes", file: "assets/mindmaps/value-streams-and-processes.html", sourceNote: "HTML version of your Value Streams and Processes mind map." },
    { title: "External Factors", file: "assets/mindmaps/external-factors.html", sourceNote: "HTML version of your External Factors mind map." }
  ],
  "service-value": [
    { title: "Service Value and Co-Creation", file: "assets/mindmaps/service-value-and-co-creation.html", sourceNote: "HTML learning mind map for this section." },
    { title: "Products and Service", file: "assets/mindmaps/products-and-service.html", sourceNote: "HTML version of your Products and Service mind map." }
  ],
  "service-relationships": [
    { title: "Service Relationships", file: "assets/mindmaps/service-relationships.html", sourceNote: "HTML learning mind map for this section." }
  ],
  "itil-value-system": [
    { title: "ITIL Value System", file: "assets/mindmaps/itil-value-system.html", sourceNote: "HTML learning mind map for this section." }
  ],
  "governance": [
    { title: "Governance", file: "assets/mindmaps/governance.html", sourceNote: "HTML learning mind map for this section." }
  ],
  "guiding-principles": [
    { title: "ITIL Guiding Principles", file: "assets/mindmaps/itil-guiding-principles.html", sourceNote: "HTML learning mind map for this section." }
  ],
  "product-service-lifecycle": [
    { title: "Product and Service Lifecycle", file: "assets/mindmaps/product-service-lifecycle.html", sourceNote: "HTML learning mind map for this section." },
    { title: "Products and Service", file: "assets/mindmaps/products-and-service.html", sourceNote: "HTML version of your Products and Service mind map." }
  ],
  "value-chain-practices": [
    { title: "Value Chain and Practices", file: "assets/mindmaps/value-chain-and-practices.html", sourceNote: "HTML learning mind map for this section." }
  ],
  "value-streams-mapping": [
    { title: "Value Streams and Mapping", file: "assets/mindmaps/value-streams-and-mapping.html", sourceNote: "HTML learning mind map for this section." }
  ],
  "continual-improvement": [
    { title: "Continual Improvement", file: "assets/mindmaps/continual-improvement.html", sourceNote: "HTML learning mind map for this section." }
  ],
  "itil-ai-frameworks": [
    { title: "ITIL, AI and Other Frameworks", file: "assets/mindmaps/itil-ai-and-other-frameworks.html", sourceNote: "HTML learning mind map for this section." }
  ]
};
