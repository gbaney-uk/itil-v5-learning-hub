  ...
  function renderMindMapTab(section) {
    ...
    return `
      <div class="mindmap-intro">
        ...
        <span>These mind maps are rendered directly inside the app from <code>content.js</code>. No external image or iframe file is loaded, so GitHub 404 path errors are avoided.</span>
      </div>
      ${maps.map((map) => `
